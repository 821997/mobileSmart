...
namespace MobileProject.Controllers
{
    public class MobilesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,name,type,color,model")] Mobile mobile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,name,type,color,model")] Mobile mobile)
        {
            if (ModelState.IsValid)
            {
